...
cout << "Address of numbersArray[0]: 
11 
<< numbersArray << endl; 
//output the value of the first element using the pointer and indirection cout << "Value at pPointer: << *pPointer << endl; 
П 
...
pPointer 
= numbersArray; 
//This outputs the value of the first element cout << "Value at pPointer++: 
return 0; 
<< *(pPointer++) << endl; 